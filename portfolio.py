    ...
    "certifications": [
        {
            ...
            "logo": "C:\\Users\\varma\\Downloads\\sst.avif",
            "logo_basename": "sst.avif"
        },
        {
            ...
            "logo" : "C:\\Users\\varma\\Downloads\\iit-ropar-01.jpg",
            "logo_basename": "iit-ropar-01.jpg"
        },
    ],
}
CHATBOT_KNOWLEDGE = {
...
def get_first_name():
    name = PORTFOLIO_DATA.get('personal_info', {}).get('name', '')
    return name.split()[0] if name else 'Surya'
@app.route('/')
def My_Portfolio():
